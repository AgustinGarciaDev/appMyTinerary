    ...
    return (
      <DrawerContentScrollView {...props}>
        {usuarioStatus ? (
          ...
          <View style={styles.containerUserFoto}>
            <Image
              style={{ width: 430, height: 80 }}
              source={{
                uri: "https://user-images.githubusercontent.com/66225450/151712674-c0b32ad5-ff0f-4036-b9ec-db3c4bdcf933.png",
              }}
            />
          </View>
        )}
